    ...
    return (
        <div className="view-question">
            ...
            {files.map((data,index) =>{
                       return(
                        <div style={{background:"yellow"}} className="ViewblogsListBox" key={index} >
                        
                        <Link to={"/ViewFiles/"+data[index].name} style={{color:"red"}}  className="ViewallBlogsLink">{data[index].name}</Link>
                    </div>
                       )
                   })}
