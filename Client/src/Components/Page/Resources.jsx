            ...
            <div className="main-wrap">
                <div className="outer-wrap">
                    ...
                    <form onSubmit={submitHandler} className="register-form" enctype="multipart/form-data">
                        ...
                        <label htmlFor="resources">Upload</label><br />
                        <input type="file" name="resources" className='user' style={{borderStyle:"none"}} id="multiFiles" multiple/><br />
                        <label htmlFor="name" name=''>File Name</label><br />
                        <input type="text" name='name'  className='Codeforces' id="name" placeholder='File Name' /><br />
