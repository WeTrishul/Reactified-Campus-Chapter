    ...
    return (
        ...
        <div>
              ...
              <div className="wrapper">
                ...
                <div className="box">
                    <input type="radio" value="A" name="select" onClick={Submitpollans} id="option-1" />
                    <input type="radio" value="B" name="select" onClick={Submitpollans} id="option-2" />
                    <input type="radio" value="C" name="select" onClick={Submitpollans} id="option-3" />
                    <input type="radio" value="D" name="select" onClick={Submitpollans} id="option-4" />
...
{ pollresult &&  <PieChart profile={pollresult} />}
