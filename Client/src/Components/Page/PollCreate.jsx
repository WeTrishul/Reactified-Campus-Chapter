        ...
        <div className='outer-wrap'>
          ...
          <form className='register-form'>
            ...
            <input
              ...
              name='pass'
              className='pass'
              placeholder='ex: Which platform is good for biginners ?'
