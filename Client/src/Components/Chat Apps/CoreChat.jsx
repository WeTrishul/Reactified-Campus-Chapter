...
function CoreChat() {
    ...
    socketRef.current.on('receive_message',(data)=>{
        ...
        {
            document.getElementById('chatbody').append("<div className='selfmsg'>"+data.message+"</div>)")
        }
        else{
            document.getElementById('chatbody').append("<div className='friendmsg'>"+data.message+"</div>)");
        }
